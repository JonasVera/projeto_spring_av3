...
public class ProjetosPringAv3Application implements CommandLineRunner{
	...
	Cartao card1 = new Cartao(null,23343322,dtVenc,"JONAS SILVA VERA",874,"20718",cnt1);
	Cartao card2 = new Cartao(null,23343322,dt.parse("30/02/2023"),"JOSE DA SILVA",684,"0000",cnt2);
 	Cartao card3 = new Cartao(null,23343322,dt.parse("30/02/2023"),"MARIA GOMES DE OLIVEIRA",124,"0202",cnt3);	
   
 	cnt1.getCartoes().addAll(Arrays.asList(card1));
